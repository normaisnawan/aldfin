        ...
        <form action="{{ route('akun.update', $akun->id) }}" method="POST">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="kode_akun" name="kode_akun"
                value="{{ old('kode_akun', $akun->kode_akun) }}" placeholder="Contoh: 1101" required>
            </div>
            <div class="col-md-6">
              <label for="nama_akun" class="form-label">Nama Akun</label>
              <input type="text" class="form-control" id="nama_akun" name="nama_akun"
                value="{{ old('nama_akun', $akun->nama_akun) }}" placeholder="Contoh: Kas Besar" required>
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="tipe_akun" name="tipe_akun" required>
              ...
              <option value="Pemasukan" {{ old('tipe_akun', $akun->tipe_akun) == 'Pemasukan' ? 'selected' : '' }}>Pemasukan
              </option>
              <option value="Pengeluaran" {{ old('tipe_akun', $akun->tipe_akun) == 'Pengeluaran' ? 'selected' : '' }}>
                Pengeluaran</option>
            </select>
          </div>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3"
              placeholder="Contoh: Akun untuk mencatat kas besar">{{ old('deskripsi', $akun->deskripsi) }}</textarea>
          </div>

        ...
        <form action="{{ route('customers.update', $customer->id) }}" method="POST">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="no_hp" name="no_hp" value="{{ old('no_hp', $customer->no_hp) }}"
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="alamat" name="alamat" rows="3"
              placeholder="Contoh: Jl. Jend. Sudirman No. 1">{{ old('alamat', $customer->alamat) }}</textarea>
          </div>

  ...
  <div class="container-fluid p-4">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        <form action="{{ route('pemasukan.store') }}" method="POST" enctype="multipart/form-data" id="formPemasukan">
          @csrf
          <div class="row mb-3">
            <div class="col-md-6">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              <label for="akun_id" class="form-label">Akun Pemasukan</label>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="keterangan" name="keterangan" rows="3"
              placeholder="Keterangan pemasukan...">{{ old('keterangan') }}</textarea>
          </div>

        ...
        <form action="{{ route('vendors.update', $vendor->id) }}" method="POST">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama', $vendor->nama) }}"
                placeholder="Contoh: PT. Sumber Makmur" required>
            </div>
            <div class="col-md-6">
              <label for="no_hp" class="form-label">No HP</label>
              <input type="text" class="form-control" id="no_hp" name="no_hp" value="{{ old('no_hp', $vendor->no_hp) }}"
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="alamat" name="alamat" rows="3"
              placeholder="Contoh: Jl. Industri No. 5">{{ old('alamat', $vendor->alamat) }}</textarea>
          </div>
